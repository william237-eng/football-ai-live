"""
prediction_registry_yellow_3_5.py
================================
Registre persistant des prédictions émises pour les cartons jaunes (OVER 3.5).
Fichier : database/prediction_registry_yellow_3_5.json
"""
...
REGISTRY_PATH = os.path.join(
    ...
    "database", "prediction_registry_yellow_3_5.json"
)
